...
/*   Updated: 2020/10/25 23:29:49 by jechoi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
** global variables
** - g_input[i] is for getting input values
**   ( ordered by col_up / col_down / row_left / row_right )
*/
...
** - parameter i is the value for check the which number
**   from the first index in board
** - parameter input_idx is the index value for g_input[]
** - seperate case for distinct which condition
**   (col_up? or col_down? or row_left? or row_right?)
...
** - function is used for check each condition
**   (col_up/down, row_left/right) individually
** - if the value has not yet been filled in the board[i][j],
**   treat the conditions as satisfied and
** - fill in the following values.
** - if meet a higher box than highest box that have seen,
**   change the max_val and count
**
** global variables
...
** - function is used for check four different condition
**   (col_up/down, row _left/right)
** - in case any one in four condition is not satisfied,
**   return false and go back
*/
...
** - check whether input number is between 1 and 4 or not
** - check whether get 16 numbers or not
** - check input numbers are distinguished
